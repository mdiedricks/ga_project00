...
var curPlayer = '';
var playerOne = '';
var playerTwo = ''; //NEW GAME - create game board

function newGame(player1, player2) {
  playerOne = player1;
  playerTwo = player2;
  curPlayer = playerOne; //create array values for the game board

  gameBoard = [" ", " ", " ", " ", " ", " ", " ", " ", " "];
} //let each player make a move until a winner is found


function makeMove(cell) {
  // turnery operator
  // (condition) ? trueStatement : falseStatement;
  var symbol = curPlayer === playerOne ? 'X' : 'O'; //assign symbol to cell value

  cell.html(symbol); // Check win

  CheckWin(); // TODO:
  // change curPlayer to be the other one.
}

function CheckWin() {// TODO: insert logic here
}

$('.cell').click(function () {
  // we have clicked on the cell
  // get the dom element that we clicked on, and pass it to our "makeMove" function
  var theClickedCell = $(this);
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","script2.js"], null)
